...
class Body extends StatelessWidget {
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            SizedBox(height: size.height * 0.03),
                        ...
                        Image.asset("assets/images/parentlogin.jpg" ,height: 120,),
  ...
  loginUser(context) async {
    ...
    if (email.isEmpty || !email.contains("@") || !email.contains(".com")) {
      Fluttertoast.showToast(msg: "Please enter a valid Email",backgroundColor: Colors.redAccent,textColor:Colors.white);
        ...
        if (doc.exists && doc["Status"] == "PENDING") {
          if (password == doc["password"]) {
            await FirebaseAuth.instance
              ...
              Fluttertoast.showToast(msg: "Password is incorrect",backgroundColor: Colors.redAccent,textColor:Colors.white);
          ...
          _btnController.error();
          Fluttertoast.showToast(msg: e.message,backgroundColor: Colors.redAccent,textColor:Colors.white);
